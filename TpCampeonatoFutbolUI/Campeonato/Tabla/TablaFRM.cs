...
namespace TPCampeonatoFutbol.Formularios.Campeonato.Tabla
{
    public partial class TablaFRM : Form
    {
        ...
        {
            estadisticasCampeonatoBE.Clear();
        ...
        public void CargarTabla()
        {
            ...
            //foreach (EstadisticasCampeonatoBE clSEstadisticasCampeonato in estadisticasCampeonato)
            //{
            //    EquipoBE equipo = equipos.FirstOrDefault(eq => eq.Id == clSEstadisticasCampeonato.Equipo);
