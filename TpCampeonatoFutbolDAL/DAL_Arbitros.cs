...
{
    public class DAL_Arbitros
    {
        private readonly DBConexion _db;

        public DataTable ObtenerArbitroPorId(Guid id)
        {
        ...
        public bool CrearArbitro(Guid id, string nombre, string apellido, string dni, int edad, DateTime fechaNacimiento, string lugarNacimiento)
        {
